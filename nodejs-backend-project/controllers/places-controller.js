...
const DUMMY_PLACES = [
  ...
  },
  {
    ...
    imageURL: "https://ancientworldwonders.com/uploads/Pyramids_of_Giza.jpg",
    address:
...
const createPlace = async (req, res, next) => {
  ...
  if (!errors.isEmpty()) {
    next(new HttpError("Invalid inputs passed, please verify your data", 422));
  }
...
const deletePlace = (req, res, next) => {
  ...
  if (!DUMMY_PLACES.find((p) => p - id === placeId)) {
    throw new HttpError(
      "Could not find the place you are trying to delete",
      404
    );
  }
